        ...
        <div class="container">
            ...
            <div class="col-md-7 single-right-left simpleCart_shelfItem">
                ...
                <p>
                    ...
                    <span class="item_price">₹{{$product->monthly_charge}} @if($product->quantity_in_grams == 1) per kg
                        @else per item @endif</span>
    ...
    margin-bottom: 10px;">*Pay online to get faster processing of your order</h5>
                                                    <input type="radio" style="width: auto;" name="payment_method"
                                                        id="payment_method" required="" value="1" checked>Pay Now
                                                    <br><input type="radio" style="width: auto;" name="payment_method"
                                ...
                                ?>
                                                ...
                                                Final Value: <span id="finalPriceText"></span><br>
                                            </div>
                                            ...
                                            <input type="hidden" id="subtotalOrder" name="subtotalOrder"
                                                value="{{$total}}">
    ...
    <script>
        function quantityPriceCalculation(n) {
           ...
           {
            document.getElementById('subtotalOrder').value = (Number(document.getElementById('monthly_charge').value) * n)/1000;
        ...
        function getHash()
{
	...
	udf5: $('#udf5').val(),
	surl : 'http://localhost:8000/post_orders_subscription?_token=' +  document.getElementById('token').value,
